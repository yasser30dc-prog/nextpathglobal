    ...
    return (
        <div className="min-h-screen bg-white pb-20 overflow-hidden">
            ...
            <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
                ...
                />
                <motion.div
                    className="absolute bottom-10 left-10 w-72 h-72 bg-blue-500/15 rounded-full blur-[100px] z-[2]"
                />
                ...
                <div className="container mx-auto px-6 relative z-10 pt-32 pb-20">
                    ...
                    >
                        <motion.span
                            ...
                            className="inline-block py-1.5 px-4 rounded-full bg-white/15 text-white font-semibold text-sm mb-6 backdrop-blur-sm border border-white/20"
                        >
                        ...
                        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-white drop-shadow-lg leading-tight">
                            Malaysia <span className="text-secondary">Employment Pass (EP)</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <Link
                                href="#categories"
                                className="bg-white/10 hover:bg-white/20 backdrop-blur-md text-white border border-white/30 font-bold py-4 px-8 rounded-full transition-all hover:shadow-md flex items-center justify-center gap-2"
                            >
                                View Categories
                            </Link>
                        </div>
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center mb-6">
                        <motion.a
                            ...
                            className="bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold py-4 px-6 rounded-full transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                        >
                        ...
                        <motion.a
                            ...
                            className="bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold py-4 px-6 rounded-full transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                        >
                            <MessageCircle size={24} /> +60 17 882 3135
                        </motion.a>
                        <motion.a
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            ...
                            className="bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold py-4 px-6 rounded-full transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                        >
                            <MessageCircle size={24} /> +60 17 296 5249
                        </motion.a>
                        <motion.a
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            ...
                            className="bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold py-4 px-6 rounded-full transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                        >
                            <MessageCircle size={24} /> +88 014 1023 7495
                        </motion.a>
                    </div>
                    <Link href="/contact">
                        <motion.button
