...
export default function TouristVisaFromMalaysiaPage() {
            ...
            <section className="bg-secondary text-white py-24 md:py-32 relative overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <Image
                        ...
                        alt="Tourist Visa Services from Malaysia"
                        fill
                        priority
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-10">
                            Your gateway to the world's most exciting destinations. Simple, fast, and reliable visa processing for travelers applying from Malaysia.
                        </p>
                    </motion.div>
                </div>
            </section>
                ...
                {filteredCountries.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {filteredCountries.map((country, index) => (
                            ...
                            >
                                <Link href={`/services/tourist-visa/from-malaysia/${country.slug}`} className="block group h-full">
