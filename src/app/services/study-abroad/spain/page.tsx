...
import { spainUniversityPartners } from "@/data/spain-partners";

export default function StudySpainPage() {
    return (
        <div className="min-h-screen bg-gray-50 pb-20">
            {/* Hero Section */}
            <section className="pt-40 pb-24 text-white relative overflow-hidden bg-cover bg-center" style={{ backgroundImage: "url('/assets/spain-study-hero.png')" }}>
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        ...
                        <p className="text-xl text-white/90 max-w-2xl mx-auto drop-shadow-md mb-10">
                            Discover world-class business, technology, and management programs in the heart of Europe.
                        </p>
                ...
                <div className="container mx-auto px-6 max-w-4xl">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Explore programs, history, and intakes of our prestigious partnered institutions in Spain.
                        </p>
                    </div>

                    <div className="space-y-8">
                        {spainUniversityPartners.map((uni, idx) => (
                            <motion.div
                                key={uni.id}
                                initial={{ opacity: 0, y: 20 }}
                                    ...
                                    <div className="flex items-start justify-between mb-2">
                                        ...
                                        {uni.qsRanking && uni.qsRanking !== "Not Globally Ranked" && (
                                            <div className="hidden md:flex flex-col items-end">
                                                <span className="text-xs uppercase font-bold text-gray-400 tracking-wider">Accreditation</span>
                                                <span className="text-lg font-bold text-secondary flex items-center gap-1">
                                                    <Globe size={16} /> {uni.qsRanking}
                                                </span>
                                            </div>
                                        )}
                                    </div>
                                    ...
                                    {uni.qsRanking && uni.qsRanking !== "Not Globally Ranked" && (
                                        <div className="md:hidden inline-block bg-gray-50 px-3 py-1 rounded-full w-max border border-gray-200">
                                            <span className="text-sm font-bold text-secondary flex items-center gap-1">
                                                <Globe size={14} /> Type: {uni.qsRanking}
                                            </span>
                                        </div>
                                    )}
