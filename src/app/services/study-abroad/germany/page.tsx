...
import { germanyUniversityPartners } from "@/data/germany-partners";
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <section
                ...
                style={{ backgroundImage: "url('/assets/germany-study-hero.webp')" }}
            >
                <div className="absolute inset-0 bg-gradient-to-b from-[#121212]/80 via-[#262626]/65 to-[#1a1a1a]/85" />
                <div className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-7xl font-extrabold mb-6 leading-tight drop-shadow-lg">
                            Study in <span className="text-[#c9a84c]">Germany</span>
                        </h1>
            ...
            {/* ── Stats Bar ── */}
            <section className="bg-[#1a1a1a] py-8 border-b border-white/5">
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center text-white">
                        {[
                            { icon: <Building2 size={22} className="text-[#c9a84c]" />, value: `${germanyUniversityPartners.length}`, label: "Partner Universities" },
                            { icon: <Star size={22} className="text-[#c9a84c]" />, value: "Tuition-Free", label: "German Public Universities" },
                            { icon: <Globe size={22} className="text-[#c9a84c]" />, value: "18 Months", label: "Post-Study Job Seeking Visa" },
                            { icon: <GraduationCap size={22} className="text-[#c9a84c]" />, value: "#1 Economy", label: "Economic Powerhouse of Europe" },
                        ].map((stat, i) => (
                            <motion.div
                                key={i}
            ...
            <section id="universities" className="py-20">
                <div className="container mx-auto px-6 max-w-5xl">
                    ...
                    <div className="text-center mb-16">
                        <span className="text-primary font-semibold tracking-wider uppercase text-sm">Study in Germany</span>
                        <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-4 text-gray-900">
                            Partner Universities &amp; Colleges
                        </h2>
                        <p className="text-gray-500 max-w-2xl mx-auto text-base">
                            Sorted by global QS ranking. Explore the rich heritage, tuition setups, intakes, and key programs at each of our prestigious German university partners.
                        </p>
                    </div>

                    {/* List Deck */}
                    <div className="space-y-8">
                        {germanyUniversityPartners.map((uni, idx) => (
                            <motion.div
                                key={uni.id}
                                initial={{ opacity: 0, y: 24 }}
                            ...
                            >
                                {/* Card Header */}
                                <div className="bg-gradient-to-r from-[#1a1a1a] to-[#2b2b2b] px-6 md:px-8 py-4 flex items-center justify-between">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="bg-white rounded-xl w-12 h-12 flex items-center justify-center shrink-0 shadow-md overflow-hidden">
                                            ...
                                            />
                                            <div className="hidden text-[#1a1a1a]">
                                                <Landmark size={22} />
                                            </div>
                                        </div>
                                        <div>
                                ...
                                <div className="p-6 md:p-8 flex flex-col gap-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm pt-2 border-t border-gray-100">
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <span className="block font-bold text-gray-900 mb-1">History &amp; Research Focus</span>
                                ...
                                <div className="bg-gray-50 border-t border-gray-100 px-6 md:px-8 py-4 flex items-center justify-between">
                                    ...
                                    <Link
                                        href="/contact"
                                        className="bg-[#1a1a1a] hover:bg-[#2b2b2b] text-white text-sm font-semibold px-6 py-2.5 rounded-full transition-all hover:-translate-y-0.5 shadow-sm inline-flex items-center gap-2"
                                    >
