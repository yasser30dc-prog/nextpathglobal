...
export const countries: CountryData[] = [
    ...
    },
    {
        ...
        requirements: [
            ...
            { icon: <FileText size={20} />, document: "Marriage Certificate", requirement: "Required for joint applications from married couples" },
        ],
        whyChoose: [
    ...
    },
    {
        ...
        requirements: [
            ...
            { icon: <Briefcase size={20} />, document: "Letter of Employment / Study", requirement: "An official letter from your current employer or educational institution" },
            { icon: <FileText size={20} />, document: "Introduction Letter", requirement: "Issued by the High Commission/Embassy based on the nationality of the applicant in Malaysia" },
            { icon: <Landmark size={20} />, document: "Bank Statement", requirement: "Bank statements of last 3 months with a minimum balance of RM 7,000/equivalent to other currency" },
            { icon: <Camera size={20} />, document: "Photograph", requirement: "One recent passport-sized photo (35 × 45 mm) with a white background" },
    ...
    },
    {
        ...
        requirements: [
            { icon: <FileText size={20} />, document: "Original Passport", requirement: "Must submit original physical passport valid for at least 6 months" },
            { icon: <Building size={20} />, document: "Malaysian Visa", requirement: "Must be valid for at least 6 months" },
            ...
            { icon: <Landmark size={20} />, document: "Bank Statement", requirement: "Certified statements from the last 6 months with a minimum balance of RM 7,000" },
            { icon: <Camera size={20} />, document: "Photograph", requirement: "One recent photo (1.77 × 1.37 inches) with a white background" },
        ],
        whyChoose: [
    ...
    },
    {
        ...
        requirements: [
            { icon: <FileText size={20} />, document: "Passport ID Page", requirement: "A clear scanned copy of your passport's information page" },
            { icon: <Building size={20} />, document: "Visa Copy", requirement: "Required if applying from outside your country of origin" },
    ...
    },
    {
        ...
        requirements: [
            ...
            { icon: <Building size={20} />, document: "Malaysian Visa", requirement: "A clear scanned copy of a valid Malaysian visa" },
            { icon: <Camera size={20} />, document: "Photograph", requirement: "One recent passport-sized photo (35 × 45 mm) with a white background" },
            { icon: <FileText size={20} />, document: "Email Address", requirement: "A valid email address is required for communication" },
            { icon: <FileText size={20} />, document: "Phone Number", requirement: "A valid phone number is required for communication" },
        ],
        whyChoose: [
