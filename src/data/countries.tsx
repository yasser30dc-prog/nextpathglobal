...
export const countries: CountryData[] = [
    ...
    },
    {
        ...
        requirements: [
            ...
            { icon: <Briefcase size={20} />, document: "Employment Confirmation Letter / NOC", requirement: "Issued by your employer on official letterhead" },
            { icon: <Briefcase size={20} />, document: "Trade License / Business Card", requirement: "As proof of professional details and credentials" },
            { icon: <Camera size={20} />, document: "Photograph", requirement: "1 recent passport-sized photo (35 × 45 mm, white background)" },
        ],
        whyChoose: [
    ...
    },
    {
        ...
        requirements: [
            { icon: <FileText size={20} />, document: "Passport", requirement: "Original passport with a minimum validity of 6 months from the date of travel" },
            { icon: <Building size={20} />, document: "Visa", requirement: "Must be valid for a minimum of 3 months" },
            { icon: <Briefcase size={20} />, document: "Employment / Enrollment Confirmation Letter", requirement: "Issued by your employer, university, or college on official letterhead" },
            { icon: <Landmark size={20} />, document: "Bank Statement", requirement: "Covering the last 3 months, with a minimum closing balance of RM 10,000" },
            { icon: <Camera size={20} />, document: "Photograph", requirement: "1 recent passport-sized photo (35 × 45 mm, white background)" },
    ...
    },
    {
        ...
        requirements: [
            { icon: <FileText size={20} />, document: "Passport", requirement: "Minimum validity of 6 months from the date of travel" },
            { icon: <Building size={20} />, document: "Malaysian Visa", requirement: "Minimum validity of 6 months" },
            { icon: <Shield size={20} />, document: "Travel Insurance", requirement: "Coverage valid for a minimum of 6 months" },
            { icon: <Briefcase size={20} />, document: "Employment / Enrollment Confirmation Letter", requirement: "Issued by your employer, university, or college on official letterhead" },
            { icon: <Landmark size={20} />, document: "Bank Statement", requirement: "Covering the last 6 months, with a minimum closing balance of RM 10,000" },
            { icon: <Camera size={20} />, document: "Photograph", requirement: "1 recent passport-sized photo (35 × 45 mm, white background)" },
