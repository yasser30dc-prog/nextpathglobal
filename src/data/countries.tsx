...
export const countries: CountryData[] = [
    ...
    },
    {
        ...
        requirements: [
            ...
            { icon: <Briefcase size={20} />, document: "Letter of Employment / Study", requirement: "An official letter from your current employer or educational institution" },
            { icon: <Landmark size={20} />, document: "Bank Statement", requirement: "Certified statements from the last 3 months with a minimum balance of RM 10,000" },
            { icon: <Plane size={20} />, document: "Travel History", requirement: "Proof of previous visas and entry/exit stamps to at least 3 countries" },
    ...
    },
    {
        ...
        requirements: [
            { icon: <FileText size={20} />, document: "Passport", requirement: "Minimum 6 months validity" },
            { icon: <Building size={20} />, document: "Visa", requirement: "Minimum 6 months validity" },
            { icon: <Shield size={20} />, document: "Travel Insurance", requirement: "6 Months" },
            { icon: <Briefcase size={20} />, document: "Employment / Study Confirmation Letter", requirement: "From Company / University / College" },
            { icon: <Landmark size={20} />, document: "Bank Statement", requirement: "Last 6 months, with minimum end balance of RM 20,000" },
            { icon: <Camera size={20} />, document: "Photograph", requirement: "1 copy (35 × 45 mm, white background)" },
