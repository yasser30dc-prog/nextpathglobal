...
export const countries: CountryData[] = [
    ...
    },
    {
        ...
        requirements: [
            { icon: <FileText size={20} />, document: "Original Passport", requirement: "Must submit your original physical passport" },
            { icon: <Building size={20} />, document: "Malaysian Visa", requirement: "A clear scanned copy of a valid Malaysian visa" },
            { icon: <Landmark size={20} />, document: "Bank Statement", requirement: "Certified statement from the last 1 month with a minimum balance of RM 7,000" },
            { icon: <Briefcase size={20} />, document: "Letter of Employment / Study", requirement: "An official letter from your current employer or educational institution" },
            { icon: <Camera size={20} />, document: "Photograph", requirement: "One recent photo (2 × 2 inches) with a white background" },
        ],
        whyChoose: [
    ...
    },
    {
        ...
        requirements: [
            ...
            { icon: <Building size={20} />, document: "Malaysian Visa", requirement: "A clear scanned copy of a valid Malaysian visa" },
            { icon: <Plane size={20} />, document: "Flight Itinerary", requirement: "Confirmed round-trip flight booking" },
            { icon: <Camera size={20} />, document: "Photograph", requirement: "Two recent passport-sized photos (35 × 45 mm) with a white background" },
        ],
        whyChoose: [
    ...
    },
    {
        ...
        requirements: [
            { icon: <FileText size={20} />, document: "Valid Passport", requirement: "Must be valid for at least 6 months" },
            { icon: <Building size={20} />, document: "Visa", requirement: "Must be valid for at least 3 months (multiple-entry)" },
            { icon: <Briefcase size={20} />, document: "Letter of Employment / Study", requirement: "An official letter from your current employer or educational institution" },
            ...
            { icon: <Plane size={20} />, document: "Travel History", requirement: "Proof of previous visas and entry/exit stamps" },
            { icon: <Camera size={20} />, document: "Photograph", requirement: "Two recent passport-sized photos (35 × 45 mm) with a white background" },
        ],
        whyChoose: [
    ...
    },
    {
        ...
        requirements: [
            { icon: <FileText size={20} />, document: "Passport's Information Page", requirement: "A clear scanned copy of your passport's information page" },
            { icon: <Building size={20} />, document: "Malaysian Visa", requirement: "A clear copy of a valid Malaysian visa" },
            { icon: <Landmark size={20} />, document: "Bank Statement", requirement: "Last 3 months with a minimum balance of RM 5,000" },
            { icon: <Briefcase size={20} />, document: "Employment / Study Confirmation Letter", requirement: "From Company, University or College" },
            { icon: <Camera size={20} />, document: "Photograph", requirement: "1 copy (2 × 2 inches, White background), also Softcopy of the same photo" },
            { icon: <FileText size={20} />, document: "Invitation Letter or Sponsor's Details", requirement: "Required for application" },
        ],
        whyChoose: [
